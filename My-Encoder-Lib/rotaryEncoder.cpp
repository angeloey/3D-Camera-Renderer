...
Rotary::Rotary(PinName encoderA, PinName encoderB, PinName button, Callback<void(void)> buttonFunc, Callback<void(void)> turnFunc):_encoderA(encoderA),_encoderB(encoderB),_button(button){
    clockwise = false;
